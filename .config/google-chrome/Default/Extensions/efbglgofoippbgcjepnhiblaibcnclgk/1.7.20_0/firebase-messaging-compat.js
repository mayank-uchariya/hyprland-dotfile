!(function (e, t) {
  ...
  try {
    !function () {
          ...
          (function (e, t) {
            const n = (function () {
              !z &&
                ...
                (z.onmessage = (e) => {
                  J(e.data.key, e.data.fid);
                }));
              return z;
            })();
            n && n.postMessage({ key: e, fid: t });
            0 === U.size && z && (z.close(), (z = null));
          })(e, t);
      }
      function J(e, t) {
        e = U.get(e);
      ...
      let z = null;
      const Y = 'firebase-installations-store';
      let Q = null;
      function Z() {
        return (
          (Q =
            ...
            k('firebase-installations-database', 1, (e) => {
              0 === e.oldVersion && e.createObjectStore(Y);
            })),
          Q
        );
      }
      async function X(e, t) {
        var n = W(e);
        const i = await Z(),
          o = i.transaction(Y, 'readwrite'),
          a = o.objectStore(Y);
        var r = await a.get(n);
        return (
          await a.put(t, n),
          await o.complete,
          (r && r.fid === t.fid) || G(e, t.fid),
          t
        );
      }
      async function ee(e) {
        e = W(e);
        const t = await Z(),
          n = t.transaction(Y, 'readwrite');
        await n.objectStore(Y).delete(e), await n.complete;
      }
      ...
      async function ne(t) {
        ...
        var e = await te(t, (e) => {
          (e = (function (e) {
            e = e || { fid: H(), registrationStatus: 0 };
            return oe(e);
          })(e)),
            (e = (function (e, t) {
              {
                      ...
                      var e = await (async function (e, { fid: t }) {
                        ...
                        if (a.ok) {
                          ...
                          return {
                            ...
                            authToken: x(e.authToken)
                          };
                        }
                        throw await $('Create Installation', a);
                      })(t, n);
                      return X(t, e);
                    } catch (e) {
                      throw (
                        (M(e) && 409 === e.customData.serverCode
                          ? await ee(t)
                          : await X(t, { fid: n.fid, registrationStatus: 0 }),
                        e)
                      );
                    }
                  })(e, t));
      ...
      function oe(e) {
        return 1 === (t = e).registrationStatus &&
          t.registrationTime + T < Date.now()
          ? { fid: e.fid, registrationStatus: 0 }
          : e;
        var t;
      }
      async function ae({ appConfig: e, platformLoggerProvider: t }, n) {
        const i =
          (([o, a] = [e, n['fid']]), `${N(o)}/${a}/authTokens:generate`);
        var o, a;
        const r = F(e, n),
          s = t.getImmediate({ optional: !0 });
        s && r.append('x-firebase-client', s.getPlatformInfoString());
        t = { installation: { sdkVersion: _ } };
        const c = { method: 'POST', headers: r, body: JSON.stringify(t) },
          u = await q(() => fetch(i, c));
        if (u.ok) return x(await u.json());
        throw await $('Generate Auth Token', u);
      }
      async function re(i, o = !1) {
        let a;
        var e = await te(i.appConfig, (e) => {
          if (!ce(e)) throw K.create('not-registered');
          var t,
            n = e.authToken;
          if (
            o ||
              ...
              return (
                (a = (async function (e, t) {
                  ...
                  for (; 1 === n.authToken.requestStatus; )
                    await L(100), (n = await se(e.appConfig));
                  var i = n.authToken;
                  return 0 === i.requestStatus ? re(e, t) : i;
                })(i, o)),
                e
              );
            ...
            return (
              (a = (async function (t, n) {
                try {
                  ...
                  return await X(t.appConfig, i), e;
                } catch (e) {
                  throw (
                    (!M(e) ||
      ...
      function se(e) {
        return te(e, (e) => {
          if (!ce(e)) throw K.create('not-registered');
          var t = e.authToken;
          return 1 === (t = t).requestStatus && t.requestTime + T < Date.now()
      ...
      async function ue(e, t = !1) {
        var n = e;
        return (
          await ((e = (await ne((e = n.appConfig))).registrationPromise) &&
            (await e)),
          (await re(n, t)).token
        );
      }
      function pe(e) {
        return K.create('missing-app-config-values', { valueName: e });
      }
      const de = 'installations',
        le = (e) => {
          e = e.getProvider('app').getImmediate();
          return {
            app: e,
            appConfig: (function (e) {
              if (!e || !e.options) throw pe('App Configuration');
              if (!e.name) throw pe('App Name');
              for (const t of ['projectId', 'apiKey', 'appId'])
                if (!e.options[t]) throw pe(t);
              return {
                appName: e.name,
            ...
            platformLoggerProvider: Bt._getProvider(e, 'platform-logger'),
            _delete: () => Promise.resolve()
          };
        },
        fe = (e) => {
          e = e.getProvider('app').getImmediate();
          const t = Bt._getProvider(e, de).getImmediate();
          return {
            getId: () =>
              (async function (e) {
                const { installationEntry: t, registrationPromise: n } =
                  await ne(e.appConfig);
                return (n || re(e)).catch(console.error), t.fid;
              })(t),
            getToken: (e) => ue(t, e)
          };
        };
      Bt._registerComponent(new s(de, le, 'PUBLIC')),
        Bt._registerComponent(new s('installations-internal', fe, 'PRIVATE')),
        Bt.registerVersion('@firebase/installations', S);
      const ge = '/firebase-messaging-sw.js',
        he = '/firebase-cloud-messaging-push-scope',
        we =
          'BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4',
        me = 'https://fcmregistrations.googleapis.com/v1',
        ye = 'google.c.a.c_id',
        be = 'google.c.a.e';
      function ve(e) {
        e = new Uint8Array(e);
      ...
      ((E = E = E || {})[(E.DATA_MESSAGE = 1)] = 'DATA_MESSAGE'),
        (E[(E.DISPLAY_NOTIFICATION = 3)] = 'DISPLAY_NOTIFICATION'),
        ((E = D = D || {}).PUSH_RECEIVED = 'push-received'),
        (E.NOTIFICATION_CLICKED = 'notification-clicked');
      const ke = 'fcm_token_details_db',
        Ie = 'fcm_token_object_Store';
      async function Se(a) {
        if ('databases' in indexedDB) {
          const t = await indexedDB.databases(),
            n = t.map((e) => e.name);
          if (!n.includes(ke)) return null;
        }
        let r = null;
        const e = await k(ke, 5, async (e) => {
          var t;
          if (!(e.oldVersion < 2) && e.objectStoreNames.contains(Ie)) {
            const o = e.transaction.objectStore(Ie);
            var n,
      ...
      const Te = 'firebase-messaging-database',
        _e = 1,
        Ce = 'firebase-messaging-store';
      let je = null;
      function Oe() {
        return (
          (je =
      ...
      async function De(e) {
        var t = Ae(e);
        const n = await Oe();
        t = await n.transaction(Ce).objectStore(Ce).get(t);
        if (t) return t;
        t = await Se(e.appConfig.senderId);
        return t ? (await Pe(e, t), t) : void 0;
      }
      async function Pe(e, t) {
        e = Ae(e);
        const n = await Oe(),
          i = n.transaction(Ce, 'readwrite');
        return await i.objectStore(Ce).put(t, e), await i.complete, t;
      }
      function Ae({ appConfig: e }) {
        return e.appId;
      }
      ...
      async function Ke(e, t) {
        var n = { method: 'DELETE', headers: await Ne(e) };
        try {
          const a = await fetch(`${Me(e.appConfig)}/${t}`, n);
          var i = await a.json();
          if (i.error) {
            var o = i.error.message;
            throw Ee.create('token-unsubscribe-failed', { errorInfo: o });
          }
        } catch (e) {
          throw Ee.create('token-unsubscribe-failed', { errorInfo: e });
        }
      }
      function Me({ projectId: e }) {
        return `${me}/projects/${e}/registrations`;
      }
      async function Ne({ appConfig: e, installations: t }) {
        t = await t.getToken();
        return new Headers({
          'Content-Type': 'application/json',
          Accept: 'application/json',
      ...
      function xe({ p256dh: e, auth: t, endpoint: n, vapidKey: i }) {
      ...
      async function Be(e) {
        ...
        var n,
          ...
          r = {
            ...
            endpoint: t.endpoint,
            auth: ve(t.getKey('auth')),
            p256dh: ve(t.getKey('p256dh'))
          },
          s = await De(e.firebaseDependencies);
        if (s) {
          if (
            ...
            return Date.now() >= s.createTime + $e
              ? (async function (t, e) {
                  try {
                    var n = await (async function (e, t) {
                        var n = await Ne(e),
                          i = xe(t.subscriptionOptions),
                          i = {
                            method: 'PATCH',
                            headers: n,
                        ...
                        if (!o.token) throw Ee.create('token-update-no-token');
                        return o.token;
                    ...
                    return await Pe(t.firebaseDependencies, i), n;
                  } catch (e) {
                    throw (await Fe(t), e);
                  }
                })(e, {
          ...
          return qe(e.firebaseDependencies, r);
        }
        return qe(e.firebaseDependencies, r);
      }
      async function Fe(e) {
        var t = await De(e.firebaseDependencies);
        t &&
          (await Ke(e.firebaseDependencies, t.token),
          await (async function (e) {
            e = Ae(e);
            const t = await Oe(),
              n = t.transaction(Ce, 'readwrite');
            await n.objectStore(Ce).delete(e), await n.complete;
      ...
      async function qe(e, t) {
        t = {
          token: await (async function (e, t) {
            ...
            let i;
            try {
              const o = await fetch(Me(e.appConfig), t);
              i = await o.json();
            } catch (e) {
              throw Ee.create('token-subscribe-failed', { errorInfo: e });
            }
            if (i.error) {
              t = i.error.message;
              throw Ee.create('token-subscribe-failed', { errorInfo: t });
            }
            if (!i.token) throw Ee.create('token-subscribe-no-token');
            return i.token;
          })(e, t),
          createTime: Date.now(),
          subscriptionOptions: t
        };
        return await Pe(e, t), t.token;
      }
      function Le(e) {
        var t,
          n,
      ...
      function Ve(e) {
        return Ee.create('missing-app-config-values', { valueName: e });
      }
      ...
      async function We(e) {
        try {
          (e.swRegistration = await navigator.serviceWorker.register(ge, {
            scope: he
          })),
      ...
      async function Ue(e, t) {
        ...
        if (
          ...
          throw Ee.create('permission-blocked');
        var n, i;
        return (
          (n = e),
          await ((i = null == t ? void 0 : t.vapidKey)
            ? (n.vapidKey = i)
            : n.vapidKey || (n.vapidKey = we)),
          await (async function (e, t) {
            if (
              (t || e.swRegistration || (await We(e)), t || !e.swRegistration)
            ) {
              if (!(t instanceof ServiceWorkerRegistration))
                throw Ee.create('invalid-sw-registration');
              e.swRegistration = t;
            }
      ...
      async function Je(e, t) {
        ...
        i.isFirebaseMessaging &&
          (e.onMessageHandler &&
            i.messageType === D.PUSH_RECEIVED &&
            ('function' == typeof e.onMessageHandler
              ? e.onMessageHandler(Le(i))
              : e.onMessageHandler.next(Le(i))),
          (n = i.data),
          'object' == typeof (t = n) &&
            t &&
            ye in t &&
            '1' === n[be] &&
            (await Ge(e, i.messageType, n)));
      }
      const ze = (e) => {
          const t = new He(
        ...
        Ye = (e) => {
          ...
          return { getToken: (e) => Ue(t, e) };
        };
      function Qe(e) {
        return (async function (e) {
          if (!navigator) throw Ee.create('only-available-in-window');
          return e.swRegistration || (await We(e)), Fe(e);
        })((e = r(e)));
      }
      function Ze(e, t) {
        return (function (e, t) {
      ...
      Bt._registerComponent(new s('messaging', ze, 'PUBLIC')),
        Bt._registerComponent(new s('messaging-internal', Ye, 'PRIVATE'));
      const Xe =
          'BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4',
        et = 'https://fcmregistrations.googleapis.com/v1',
        tt = 'FCM_MSG',
        nt = 'google.c.a.c_id',
        it = 3,
        ot = 1;
      ...
      ((E = P = P || {})[(E.DATA_MESSAGE = 1)] = 'DATA_MESSAGE'),
        (E[(E.DISPLAY_NOTIFICATION = 3)] = 'DISPLAY_NOTIFICATION'),
        ((E = A = A || {}).PUSH_RECEIVED = 'push-received'),
        (E.NOTIFICATION_CLICKED = 'notification-clicked');
      const rt = 'fcm_token_details_db',
        st = 'fcm_token_object_Store';
      async function ct(a) {
        if ('databases' in indexedDB) {
          const t = await indexedDB.databases(),
            n = t.map((e) => e.name);
          if (!n.includes(rt)) return null;
        }
        let r = null;
        const e = await k(rt, 5, async (e) => {
          var t;
          if (!(e.oldVersion < 2) && e.objectStoreNames.contains(st)) {
            const o = e.transaction.objectStore(st);
            var n,
              i = await o.index('fcmSenderId').get(a);
            await o.clear(),
              i &&
      ...
      const ut = 'firebase-messaging-database',
        pt = 1,
        dt = 'firebase-messaging-store';
      let lt = null;
      function ft() {
        return (
          (lt =
            lt ||
            k(ut, pt, (e) => {
              0 === e.oldVersion && e.createObjectStore(dt);
            })),
          lt
        );
      }
      async function gt(e) {
        var t = wt(e);
        const n = await ft();
        t = await n.transaction(dt).objectStore(dt).get(t);
        if (t) return t;
        t = await ct(e.appConfig.senderId);
        return t ? (await ht(e, t), t) : void 0;
      }
      async function ht(e, t) {
        e = wt(e);
        const n = await ft(),
          i = n.transaction(dt, 'readwrite');
        return await i.objectStore(dt).put(t, e), await i.complete, t;
      }
      function wt({ appConfig: e }) {
        return e.appId;
      }
      const mt = new i('messaging', 'Messaging', {
        'missing-app-config-values':
          'Missing App configuration value: "{$valueName}"',
        'only-available-in-window':
          'This method is available in a Window context.',
      ...
      async function yt(e, t) {
        var n = { method: 'DELETE', headers: await vt(e) };
        try {
          const a = await fetch(`${bt(e.appConfig)}/${t}`, n);
          var i = await a.json();
          if (i.error) {
            var o = i.error.message;
            throw mt.create('token-unsubscribe-failed', { errorInfo: o });
          }
        } catch (e) {
          throw mt.create('token-unsubscribe-failed', { errorInfo: e });
        }
      }
      function bt({ projectId: e }) {
        return `${et}/projects/${e}/registrations`;
      }
      async function vt({ appConfig: e, installations: t }) {
        t = await t.getToken();
        return new Headers({
          'Content-Type': 'application/json',
          Accept: 'application/json',
      ...
      function kt({ p256dh: e, auth: t, endpoint: n, vapidKey: i }) {
        const o = { web: { endpoint: n, auth: t, p256dh: e } };
      ...
      async function It(e) {
        ...
        var n,
          ...
          r = {
            ...
            swScope: e.swRegistration.scope,
            endpoint: t.endpoint,
            auth: at(t.getKey('auth')),
            p256dh: at(t.getKey('p256dh'))
          },
          s = await gt(e.firebaseDependencies);
        if (s) {
          if (
            ((n = s.subscriptionOptions),
            (i = r.vapidKey === n.vapidKey),
            ...
            return Date.now() >= s.createTime + 6048e5
                  ...
                  try {
                    var n = await (async function (e, t) {
                        ...
                        try {
                          ...
                          throw mt.create('token-update-failed', {
                            errorInfo: e
                          });
                        }
                        if (o.error) {
                        ...
                        if (!o.token) throw mt.create('token-update-no-token');
                        return o.token;
                      })(t.firebaseDependencies, e),
                      i = Object.assign(Object.assign({}, e), {
                        token: n,
                    ...
                    return await ht(t.firebaseDependencies, i), n;
                  } catch (e) {
                    throw (await St(t), e);
                  }
                })(e, {
              ...
              : s.token;
          try {
            await yt(e.firebaseDependencies, s.token);
          } catch (e) {
            console.warn(e);
          }
          return Tt(e.firebaseDependencies, r);
        }
        return Tt(e.firebaseDependencies, r);
      }
      async function St(e) {
        var t = await gt(e.firebaseDependencies);
        t &&
          (await yt(e.firebaseDependencies, t.token),
          await (async function (e) {
            e = wt(e);
            const t = await ft(),
              n = t.transaction(dt, 'readwrite');
            await n.objectStore(dt).delete(e), await n.complete;
          })(e.firebaseDependencies));
        const n = await e.swRegistration.pushManager.getSubscription();
        return !n || n.unsubscribe();
      }
      async function Tt(e, t) {
        t = {
          token: await (async function (e, t) {
            ...
            let i;
            try {
              const o = await fetch(bt(e.appConfig), t);
              i = await o.json();
            } catch (e) {
              throw mt.create('token-subscribe-failed', { errorInfo: e });
            }
            if (i.error) {
              t = i.error.message;
              throw mt.create('token-subscribe-failed', { errorInfo: t });
            }
            if (!i.token) throw mt.create('token-subscribe-no-token');
            return i.token;
          })(e, t),
          createTime: Date.now(),
          subscriptionOptions: t
        };
        return await ht(e, t), t.token;
      }
      async function _t(e, t) {
        t = (function (e, t) {
          ...
          (n.instance_id = t),
            e.notification
              ? (n.message_type = P.DISPLAY_NOTIFICATION.toString())
              : (n.message_type = P.DATA_MESSAGE.toString());
          (n.sdk_platform = it.toString()),
      ...
      async function jt(e, t) {
        ...
        if (n) {
          t.deliveryMetricsExportedToBigQueryEnabled && (await _t(t, n));
          var i,
            o,
            a = await Dt();
          if (
            ...
            return (function (e, t) {
              (t.isFirebaseMessaging = !0), (t.messageType = A.PUSH_RECEIVED);
      ...
      async function Ot(e) {
        ...
        if (t && !e.action) {
          ...
          var n = (function (e) {
            ...
            if (n) return n;
            return (function (e) {
              return 'object' == typeof e && e && nt in e;
            })(e.data)
          ...
          if (n) {
            ...
            if (o.host === e.host) {
              ...
              if (
                ...
                return (
                  (t.messageType = A.NOTIFICATION_CLICKED),
      ...
      function Pt(e) {
        return mt.create('missing-app-config-values', { valueName: e });
      }
      Ct('hts/frbslgigp.ogepscmv/ieo/eaylg', 'tp:/ieaeogn-agolai.o/1frlglgc/o'),
        Ct('AzSCbw63g1R0nCw85jG8', 'Iaya3yLKwmgvh7cF0q4');
      class At {
        constructor(e, t, n) {
          (this.deliveryMetricsExportedToBigQueryEnabled = !1),
            (this.onBackgroundMessageHandler = null),
            ...
            (this.isLogServiceStarted = !1);
          var i = (function (e) {
            if (!e || !e.options) throw Pt('App Configuration Object');
            if (!e.name) throw Pt('App Name');
            var t = e['options'];
            for (const n of [
              'projectId',
              'apiKey',
        ...
        return (
          ...
          self.addEventListener('pushsubscriptionchange', (e) => {
            e.waitUntil(
              (async function (e, t) {
                (e = e['newSubscription'])
                  ? ((e = await gt(t.firebaseDependencies)),
                    await St(t),
                    (t.vapidKey =
                      null !==
                        (e =
      ...
      function Kt(e, t) {
        return (function (e, t) {
          if (void 0 !== self.document) throw mt.create('only-available-in-sw');
          return (
      ...
      Bt._registerComponent(new s('messaging-sw', Et, 'PUBLIC'));
      class Mt {
        constructor(e, t) {
          (this.app = e),
            (this._delegate = t),
        ...
        async deleteToken() {
          return Qe(this._delegate);
        }
        onMessage(e) {
          return Ze(this._delegate, e);
        }
      ...
      t.default.INTERNAL.registerComponent(
        new s('messaging-compat', Nt, 'PUBLIC').setServiceProps(xt)
      ),
        t.default.registerVersion('@firebase/messaging-compat', '0.1.1');
