!(function (e, t) {
  ...
  function x(e) {
    ...
    if ($.has(t))
      return (
        k.debug(`There were multiple attempts to register component ${t}.`), !1
      );
    $.set(t, e);
    for (const n of j.values()) T(n, e);
    return !0;
  }
  function M(e, t) {
    return e.container.getProvider(t);
  }
  const B = new o('app', 'Firebase', {
    'no-app':
  ...
  function G(e, t = {}) {
    ...
    const i = new E(r);
    for (const o of $.values()) i.addComponent(o);
    n = new V(e, n, i);
    return j.set(r, n), n;
  }
  async function W(e) {
  ...
  function Y(e, t, n) {
    ...
    x(new g(`${i}-version`, () => ({ library: i, version: t }), 'VERSION'));
  }
  function K(e, t) {
  ...
  x(new g('platform-logger', (e) => new D(e), 'PRIVATE')),
    Y(R, '0.7.1', P),
    Y('fire-js', '');
  var X = Object.freeze({
    __proto__: null,
    ...
    _removeServiceInstance: function (e, t, n = z) {
      M(e, t).clearInstance(n);
    },
    deleteApp: W,
    getApp: function (e = z) {
      var t = j.get(e);
  ...
  class Z {
    constructor(e, t) {
      (this._delegate = e),
        (this.firebase = t),
        T(e, new g('app-compat', () => this, 'PUBLIC')),
    ...
    delete() {
      return new Promise((e) => {
        ...
        () => (this.firebase.INTERNAL.removeApp(this.name), W(this._delegate))
      );
    }
    _getService(e, t = z) {
  ...
  function Q(i) {
    ...
    function s(e) {
      if (((e = e || z), !c(n, e))) throw q.create('no-app', { appName: e });
      return n[e];
    }
    return (
      (o.default = o),
  ...
  const te = new S('@firebase/app-compat');
  if (
    'object' == typeof self &&
    self.self === self &&
  ...
  `);
    const re = self.firebase.SDK_VERSION;
    re &&
      0 <= re.indexOf('LITE') &&
      te.warn(`
  ...
  const ne = ee;
  Y('@firebase/app-compat', '0.1.2', void 0);
  return ne.registerVersion('firebase', '9.1.0', 'app-compat-cdn'), ne;
});
